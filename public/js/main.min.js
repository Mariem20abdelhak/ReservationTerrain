...
if (
  ...
  navNavigationBarLi.forEach(function (a) {
    return a.addEventListener("click", function () {
      var b = Array.from(a.parentElement.children);
  ...
  (window.onscroll = function () {
    window.pageYOffset > headerSection.offsetHeight - 75
      ? (nav.classList.add("active"), (logoImage.src = "img/logo-rosa.png"))
      : (nav.classList.remove("active"),
        (logoImage.src = "img/logo-rosa-white.png")),
      0 < window.pageYOffset &&
        (headerText.style.opacity = -window.pageYOffset / 300 + 1),
      "ROSA- Restaurant" === pageTitle.text &&
        (window.pageYOffset < 0.5 * headerSection.offsetHeight
          ? (dots.forEach(function (a) {
              return a.classList.remove("black");
            }),
            dotTwo.classList.remove("active"),
            dotOne.classList.add("active"))
          : window.pageYOffset > 0.5 * headerSection.offsetHeight &&
            window.pageYOffset < 0.72 * recipeSection.offsetTop
          ? dots.forEach(function (a) {
              return a.classList.add("black");
            })
          : window.pageYOffset > 0.75 * recipeSection.offsetTop &&
            window.pageYOffset < 0.81 * menuSection.offsetTop
          ? (dots.forEach(function (a) {
              return a.classList.remove("black");
            }),
          ...
          : window.pageYOffset > 0.81 * menuSection.offsetTop &&
            window.pageYOffset < 0.86 * fixedImageSection.offsetTop
          ? (dots.forEach(function (a) {
              return a.classList.add("black");
            }),
            dotThree.classList.remove("active"),
            dotTwo.classList.add("active"))
          : window.pageYOffset > 0.86 * fixedImageSection.offsetTop &&
            window.pageYOffset < 0.72 * footerSection.offsetTop
          ? (dots.forEach(function (a) {
              return a.classList.remove("black");
            }),
            dotTwo.classList.remove("active"),
          ...
          : window.pageYOffset > 0.72 * footerSection.offsetTop &&
            window.pageYOffset < 0.901 * footerSection.offsetTop
          ? dots.forEach(function (a) {
              return a.classList.add("black");
            })
          : window.pageYOffset > 0.901 * footerSection.offsetTop &&
  ...
  var boxModelFun = function (a) {
    if (
      (("Escape" === a.code ||
        ("DIV" === a.target.tagName && !a.target.classList.contains("arrow")) ||
        a.target.classList.contains("close")) &&
        (boxModel.classList.remove("active"),
        body.classList.remove("hide-scroll")),
      boxModel.classList.contains("active") &&
        ("ArrowRight" === a.code ||
          "ArrowLeft" === a.code ||
          a.target.classList.contains("arrow-right") ||
          a.target.classList.contains("arrow-left")))
    ) {
      var b = Array.from(menuImageContainer.children),
        c = b.find(function (d) {
          return d.classList.contains("active");
        });
      a.target.classList.contains("arrow-right") || "ArrowRight" === a.code
        ? null === c.nextElementSibling
          ? (c.parentElement.firstElementChild.classList.add("active"),
            (boxModelImage.src =
              c.parentElement.firstElementChild.firstElementChild.src))
          : (c.nextElementSibling.classList.add("active"),
            (boxModelImage.src = c.nextElementSibling.firstElementChild.src))
        : (a.target.classList.contains("arrow-left") ||
            "ArrowLeft" === a.code) &&
          (null === c.previousElementSibling
            ? (c.parentElement.lastElementChild.classList.add("active"),
              (boxModelImage.src =
                c.parentElement.lastElementChild.lastElementChild.src))
            : (c.previousElementSibling.classList.add("active"),
              (boxModelImage.src =
                c.previousElementSibling.firstElementChild.src))),
  ...
  svgDown.addEventListener("click", function () {
    ...
    menuImgs.forEach(function (a) {
      return a.addEventListener("click", function () {
        var b = Array.from(this.parentElement.parentElement.children);
        b.forEach(function (c) {
          return c.classList.remove("active");
        }),
